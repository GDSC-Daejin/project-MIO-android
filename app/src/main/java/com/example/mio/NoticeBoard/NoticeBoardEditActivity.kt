       ...
       /* mBinding.datePickerBtn.setOnClickListener {
        ...
        myViewModel.checkComplete.observe(this) {
            if (it) {
                ...
                mBinding.editNext.setOnClickListener { // ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
...
/*                2 -> {
        ...
        recentSearchAdapter.setItemClickListener(object : PlaceAdapter.OnItemClickListener {
            override fun onClick(v: View, position: Int) {
                ...
                marker = MapPOIItem().apply {
                    ...
                    customSelectedImageResourceId = R.drawable.map_poi_icon2
    ...
    override fun onMapViewSingleTapped(mapView: MapView?, mapPoint: MapPoint?) {
        ...
        marker = MapPOIItem().apply {
            ...
            customImageResourceId = R.drawable.map_poi_icon2
            isCustomImageAutoscale = true
            isDraggable = true
            setCustomImageAnchor(0.5f, 1.0f)
        }
